...
<?php // Can't add a new page unless we have a subject as a parent!
	if(!$current_subject) {
...
$query.="  subject_id, menu_name, full_name, country, city, address, position, visible, content, reasons";
$query.=") VALUES (";
$query.="  {$subject_id}, '{$menu_name}', '{$full_name}','{$country}', '{$city}','{$address}', {$position}, {$visible}, '{$content}','{$reasons}'";
$query.=")";
...
// Failure
$_SESSION["message"]="Activity creation failed.";
}
}
} else {
...
<div id="main">
	...
	<div id="page">
		...
		<h2  style="margin-top: 10px; border-bottom: 2px solid  #E7AE5F; width: 99%">Create Activity</h2>
		<form class="ui  form segment" action="new_page.php?subject=<?php echo urlencode($current_subject["id"]); ?>" method="post">
			...
			<p>
				Reasons:
				<br />
				<textarea name="reasons" rows="20" cols="80"></textarea>
			</p>
			<p>
				Position:
			...
			<input class="ui teal submit button" type="submit" name="submit" value="Create Activity" />
		</form>
		<br />
